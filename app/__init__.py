...
def create_app(config_name):
    ...
    """ This ensures that the urls /login and /login/ are recognized as same without considering the trailing slash """
    ...
    def error_500(e):
        return jsonify(
            {"code": "503", "message": "We have some trouble processing your request please try again later"}), 500

    @app.errorhandler(405)
    def error_405(e):
        return jsonify({"code": "405", "message" : "We dont allow the request method", "ok": False}), 200
